  ...
  return (
    <section className="py-24 px-4 bg-black text-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-start text-left mb-16 border-b border-white/10 pb-8">
          <h2 className="text-6xl md:text-8xl font-display font-bold tracking-tighter uppercase mb-4">
            MI7 Artists
          </h2>
          <p className="text-gray-400 max-w-xl text-lg font-light flex flex-col gap-1">
        ...
        <div className="mt-16 flex justify-center md:hidden">
          <Link to="/artists" className="px-8 py-4 border border-white/20 text-white font-medium tracking-widest uppercase text-sm hover:bg-white/5 transition-colors">
            View All Artists
          </Link>
        </div>
      </div>
